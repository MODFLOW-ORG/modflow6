...
The maximum horizontal extent of a cell is calculated from the cell vertices for the DIS and DISV grids and from the cell area for the DISU grid, which does not require them.
