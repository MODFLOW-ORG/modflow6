...
The PRT Model reports a high-level particle mass budget to the listing file and the binary cell budget file, with terms for release, storage, and termination only. It does not yet account for flows to distinct boundary conditions.
