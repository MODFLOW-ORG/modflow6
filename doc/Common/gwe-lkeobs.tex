...
LKE & lakebed-cond & lakeno or boundname & -- & Amount of heat conductively exchanged with the lakebed material.  If a boundname is specified for ID, then the result is the total conductive exchange summed over all of the lakebed connections of the named lake.  Otherwise, the conductive exchange of the first lakebed connection of lake \texttt{lakeno} is observed.
