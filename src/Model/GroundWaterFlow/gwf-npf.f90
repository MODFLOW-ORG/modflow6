module GwfNpfModule
  ...
  type, extends(NumericalPackageType) :: GwfNpfType
    ...
    type(GwfNpfFormContainerType), dimension(:), allocatable, private :: &
...
contains
  ...
  subroutine npf_cr(npfobj, name_model, input_mempath, inunit, iout)
    ...
    ! (alternative) flow formulations
    allocate (npfobj%flow_formulations(SIZE_FORMULATIONS))
  ...
  subroutine add_flow_formulation(this, npf_form, form_id)
    ...
    this%flow_formulations(form_id + 1)%form => npf_form
