...
module GwtMwtModule
  ...
  contains
    ...
    procedure :: apt_setting_value => mwt_setting_value
...
contains
  ...
  !<
  function mwt_setting_value(this, itemno, key) result(val)
    ! -- dummy
    ...
    case ('RATE')
      val = this%concrate(itemno)
    end select
  end function mwt_setting_value
